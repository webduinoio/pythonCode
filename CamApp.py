...
try:
    ...
    # KingKit_demo01
    #if CamApp.init('wa001','KingKit_2.4G','webduino'):
    #    CamApp.setUploadFolder('1l26h3GZzC6b0GsgHbFHNEXFnoTGxEaM7',sendTime=1)
    #    CamApp.run(enableDeepSleepMode = 0) # do not deepsleep

    # NiNa
    #url: https://drive.google.com/drive/folders/1duMa9Gw57_j30XmtoCdCzdUhSZ-xWjmu?usp=sharing
    if CamApp.init('nina','KingKit_2.4G','webduino'):
        CamApp.setUploadFolder('1L25XnMlt16zSA_6eUT0iYiO0LCWC3xzB',sendTime=1)
        CamApp.run(enableDeepSleepMode = 0) # do not deepsleep
